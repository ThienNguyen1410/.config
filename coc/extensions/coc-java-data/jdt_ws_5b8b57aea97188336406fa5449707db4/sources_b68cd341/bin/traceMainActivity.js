...
var printBacktrace = function () {
    Java.perform(function() {
        var ndroid_util_Log = Java.use('android.util.Log'), java_lang_Exception = Java.use('java.lang.Exception');
...
var Main = function() {
    Java.perform(function () { // avoid java.lang.ClassNotFoundException
        [
            // "java.io.File",
            'com.scan.database.AppDatabaseHelper'
        ].forEach(traceClass);

        Java.use('com.scan.database.AppDatabaseHelper').AppDatabaseHelper.overload().implementation = function () {
            LOG('Trace class', { c: Color.Light.Cyan });
            printBacktrace();
            return true;
        }
    });
